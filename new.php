...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $query = "SELECT * FROM newCars Where 1=1";
    ...
    if ($fuelType) $query .= " AND fuelType = :fuelType";
    ...
    if ($fuelType) $stmt->bindValue(':fuel_type', $fuelType);
...
<body>
    ...
    <div class="trendItems">
        <h3>Witness our new range of vehicles</h3>
        <h1>BMW 3 series</h1>
        <div class="btnContainer">
            <button style="background-color: darkgray;">More Details</button>
            <button>Test Drive</button>
        </div>
        <img class="used" src="images/grahame-jenkins-p7tai9P7H-s-unsplash-removebg-preview.png" alt="cartitleimage">
    </div>
    <main>
        <h2>New Cars</h2>
